/*Criar o famoso jogo da velha para rodar no terminal e que permita a ação de dois jogadores.*/
...
int main(){
    ...
    do {
        ...
        do {
            ...
            // alguém ganhou por diagonal principal
            ...
            // alguém ganhou por diagonal secundária
        ...
        if (ganhou == 0)
            printf("O jogo finalizou sem nenhum vencedor!\n");
